<div>
    ...
    <style>
        ...
        .ip-sm{padding:.3rem .6rem !important;font-size:.82rem !important;}
        .ip-toggle.ip-sm{padding:0 !important;}
        .ip-toggle.ip-sm button{padding:.3rem 0 !important;font-size:.82rem !important;}
    ...
    <div class="ip-card">
        ...
        <div class="row g-4 align-items-start">
            <div class="col-12 col-md-5">
                ...
                <select class="ip-select ip-sm" wire:model.live="empresaSeleccionada">
            ...
            <div class="col-12 col-md-4">
                @if($modoRango === 'periodo')
                    ...
                    <div class="d-flex gap-2">
                        <select class="ip-select ip-sm" wire:model.live="filtroMes">
                        ...
                        <select class="ip-select ip-sm" wire:model.live="filtroAnio" style="max-width:110px;">
                ...
                @else
                    <div class="row g-2">
                        <div class="col-6">
                            ...
                            <input type="date" class="ip-select ip-sm" wire:model.live="filtroDesde">
                        </div>
                        <div class="col-6">
                            <label class="ip-label">Hasta</label>
                            <input type="date" class="ip-select ip-sm" wire:model.live="filtroHasta">
                        </div>
                    </div>
                @endif
            </div>
    ...
    <div class="ip-card">
        ...
        <div class="row g-4">
            <div class="col-12 col-md-4">
                ...
                <select class="ip-select ip-sm" wire:model.live="filtroFamilia">
                    <option value="0">Todos</option>
            ...
            <div class="col-12 col-md-4">
                ...
                <select class="ip-select ip-sm" wire:model.live="filtroCategoria">
                    <option value="0">Todos</option>
