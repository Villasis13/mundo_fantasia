...
Route::prefix('logistica')->middleware(['auth', 'verifyUserStatus'])->group(function () {
    ...
    Route::get('/autoconsumo-excel-consolidado',[LogisticaController::class ,'autoconsumo_excel_consolidado'])->name('logistica.autoconsumo_excel_consolidado')->middleware('can:autoconsumo.submenu');
    Route::get('/autoconsumo-excel-detallado',[LogisticaController::class ,'autoconsumo_excel_detallado'])->name('logistica.autoconsumo_excel_detallado')->middleware('can:autoconsumo.submenu');
